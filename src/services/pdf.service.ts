...
export class PdfService {
  public create(req: Request, res: Response) {
    ...
    /* first row */
    /**  header left - data */
    let logoHeader = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAB3RJTUUH5AYYDxUjxWKpvwAAAB1pVFh0Q29tbWVudAAAAAAAQ3JlYXRlZCB3aXRoIEdJTVBkLmUHAAAADklEQVQY02NgGAWDEwAAAZoAAQuinR8AAAAASUVORK5CYII=';  //blank image
    ...
    let dd = {
              ...
              body: [
                ...
                [{
                  ...
                  columns: [
                    ...
                    { text: customerPhoneLabel + " " + customerPhone, style: 'headerCenter' },
                    { text: customerEmailLabel + " " + customerEmail, style: 'headerRight' }
                  ]
                }]
              ]
            }
              ...
              body: [
                ...
                [{
                  ...
                  columns: [
                    ...
                    { text: configurationDateLabel + " " + configurationDate, style: 'headerRight' }
                  ]
                }],
                [{
                  border: borderBottom,
                  columns: [
                    ...
                    { text: controlBoardLabel + " " + controlBoard, style: 'headerCenter' },
                    { text: fwLabel + " " + fw, style: 'headerRight' }
                  ]
                }]
              ]
            }
                ...
                body: [
                  [{
                    ...
                    columns: [
                      ...
                      { width: 60, text: poweredByLabel, margin: [0, 0, 9, 0], style: "footerBase", alignment:"right" },
                      { width: 70, image: logoFooter, margin: [0, 0, 0, 0], style: "footerBase" }
                    ]
                  }]
                ]
              }
      ...
      styles: {
        ...
        headerCenter: { fontSize: 10, italics: false, bold: false, alignment: 'center' },
        ...
        footerBase: { fontSize: 8, italics: false },
      }
    };
