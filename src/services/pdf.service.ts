...
export class PdfService {
  public create(req: Request, res: Response) {
    ...
    let address = "via delle vie, Lomazzo (CO)";
    let telephoneNumber = "(+39)0331.610000";
    let email = "email@email.it"

    let title = "PARAMETRI DI CONFIGURAZIONE AUTOMAZIONE";
    ...
    let dd = {
      content: [
          ...
          columns: [
            ...
            },
            {
              ...
              table: {
                widths: [200],
                body: [
                  [{ text: factoryName, border: [true, true, true, false], style: 'headerDx' }],
                  [{ text: address, border: [true, false, true, false], style: 'headerDx' }],
                  [{ text: telephoneNumber, border: [true, false, true, false], style: 'headerDx' }],
                  [{ text: email, border: [true, false, true, true], style: 'headerDx' }]
                ]
              }
            }
          ]
        ...
        {
          margin: [0, 30, 0, 0],
          columns: [{ text: title, style: "titleStyle" }]          
        }        
      ],
      styles: {
        headerDx: { fontSize: 11, bold: false, italics: true, alignment: 'right' },
        titleStyle: {fontSize: 14, bold: true, alignment: 'center'}
      }
    };
