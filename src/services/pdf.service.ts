      ...
      content: [
        /* first row */
        {
          columns: [
            ...
            {
              /* header dx */
              margin: [170, 0, 0, 0], //[left, top, right, bottom]
              table: {
                widths: [200],
                body: [
                  [{ text: factoryName, border: [true, true, true, false], style: 'headerRight' }],
                  [{ text: address, border: [true, false, true, false], style: 'headerRight' }],
                  [{ text: telephoneNumber, border: [true, false, true, false], style: 'headerRight' }],
                  [{ text: email, border: [true, false, true, true], style: 'headerRight' }]
                ]
              }
            }
          ]
          ...
          columns: [
            {
              table: {
                widths: [220],
                body: [
                  [{ text: siteLabel, border: [true, true, true, false], style: 'headerBoldLeft' }],
                  [{ text: siteName, border: [true, false, true, false], style: 'headerLeft' }],
                  [{ text: siteAddress, border: [true, false, true, true], style: 'headerLeft' }]
                ]
              }
            },
            {
              ...
              table: {
                widths: [220],
                body: [
                  [{ text: automationLabel, border: [true, true, true, false], style: 'headerBoldLeft' }],
                  [{ text: automationName, border: [true, false, true, false], style: 'headerLeft' }],
                  [{ text: automationAddress, border: [true, false, true, true], style: 'headerLeft' }]
                ]
              }
            }
          ]
